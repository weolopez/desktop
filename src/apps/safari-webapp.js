class SafariWebapp extends HTMLElement {
    ...
    async initializeSession() {
        try {
            ...
            const response = await fetch('http://localhost:3002/api/chrome/new-session', {
                method: 'POST',
    ...
    async closeSession() {
        if (this.sessionId) {
            try {
                await fetch('http://localhost:3002/api/chrome/close-session', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
    ...
    async loadUrl(url) {
        ...
        try {
            const response = await fetch('http://localhost:3002/api/chrome/navigate', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    async goBack() {
        ...
        try {
            const response = await fetch('http://localhost:3002/api/chrome/back', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ sessionId: this.sessionId })
            });
    ...
    async goForward() {
        ...
        try {
            const response = await fetch('http://localhost:3002/api/chrome/forward', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ sessionId: this.sessionId })
            });
    ...
    async refresh() {
        ...
        try {
            const response = await fetch('http://localhost:3002/api/chrome/refresh', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ sessionId: this.sessionId })
            });
    ...
    async clickAt(x, y) {
        ...
        try {
            const response = await fetch('http://localhost:3002/api/chrome/click', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
