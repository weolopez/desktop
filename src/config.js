export const APPS = [
    ...
    { id: 'notification', name: 'Notification', icon: '�', sourceUrl: '/apps/notification/notification-display-component.js', tag:"notification-display-component", onstartup: false, static: true }
];
