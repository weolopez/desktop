class DockComponent extends HTMLElement {
    constructor() {
        ...
        this.apps = [
            ...
            { id: 'textedit', name: 'TextEdit', icon: '📝', running: false },
            { id: 'system-preferences', name: 'System Preferences', icon: '⚙️', running: false },
            { id: 'activity-monitor', name: 'Activity Monitor', icon: '📊', running: false }
        ];
